...
public:
	...
	Gui_Elements* Create_Button(Element_type element, iPoint position, SDL_Rect rect, SDL_Texture* tex = nullptr, Function function = Function::NONE, Gui_Elements* Parent = nullptr, Button_type button = Button_type::NONE);
